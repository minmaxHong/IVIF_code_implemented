...
class attention(nn.Module):
    ...
    def forward(self, ir, rgb):
        ...
        return edgemap_ir, edgemap_rgb, ir-edgemap_ir, rgb-edgemap_rgb
...
class CMTFusion(nn.Module):
    ...
    def forward(self, rgb, ir):
        ...
        edgemap_ir, edgemap_rgb, basepart_ir, basepart_rgb = self.attention(ir, rgb)
        
        save_image(edgemap_ir, 'edgemap_ir.png')
        save_image(edgemap_rgb, 'edgemap_rgb.png')
        save_image(basepart_ir, 'basepart_ir.png')
        save_image(basepart_rgb, 'basepart_rgb.png')
