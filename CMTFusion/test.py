...
def run():
    ...
    parser.add_argument('--test_images', type=str, default=r'C:\Users\USER\Desktop\code\sungmin_github\mmLab\case2', help='path of source image')
    parser.add_argument('--dataset_name', type=str, default='basic', help='dataset name')
    parser.add_argument('--weights', type=str, default=r'C:\Users\USER\Desktop\code\sungmin_github\mmLab\made_pt\pretrained.pth', help='dataset name')
