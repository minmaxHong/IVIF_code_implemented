...
def main():
    ...
    parser.add_argument('--rgb_dataset', type=str, default=r'C:\Users\USER\Desktop\Dataset\KAIST', help='path of rgb dataset')
    parser.add_argument('--ir_dataset', type=str, default=r'C:\Users\USER\Desktop\Dataset\KAIST', help='path of ir dataset')
